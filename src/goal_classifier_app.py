...
def load_model(model_path="./goal_classifier_model"):
    ...
    if os.path.exists(model_path) and os.path.isdir(model_path):
        ...
        # If not found locally, try to load from Hugging Face Hub
        # Replace with your actual model name on Hugging Face
        hf_model_name = "your-username/goal-classifier"
...
def classify_goal(goal_text):
    ...
    # Classify the goal
    prediction = predict_goal_type(goal_text, model, tokenizer)
